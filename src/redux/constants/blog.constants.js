...
export const UPDATE_REACTION_REQUEST = "BLOG.UPDATE_REACTION_REQUEST";
export const UPDATE_REACTION_SUCCESS = "BLOG.UPDATE_REACTION_SUCCESS";
export const UPDATE_REACTION_FAILURE = "BLOG.UPDATE_REACTION_FAILURE";
